...
// config driven ui: When you build real world aapplication, you want your website should
// work in multiple city. So we control our frontend using a config.
// All the ui driven by config which is sent by backend
...
/*OPTIONAL CHAINING: Read about this*/
const RestrauntCard = () => {
  return (
    <div className="card">
      <img src={
        "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/" +
        restrautList[3].data?.cloudinaryImageId}
      />
      <h2>{restrautList[0].data?.name}</h2>
      <h3>{restrautList[0].data?.cuisines.join(",")}</h3>
      <h4>{restrautList[0].lastMileTravelString}</h4>
    </div>
  )
}
...
//     cards: [{
//       name: "Burger King",
//       image: "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_208,h_208,c_fit/n3xekdsgny6jdboxy4xw",
